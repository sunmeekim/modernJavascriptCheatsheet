...
이 문서는  당신이 요즘 프로젝트나 샘플 코드에서 자주 보고있는 자바스크립트를 위한 가이드입니다.

이 가이드는 초보자를 위한 것은 아닙니다. 자바스크립트 개발자들이 최근 코드와 친해질 수 있도록 하기 위한 것입니다.

또, 논쟁의 여지가 있는 것을 쓸 때 개인적으로 추천하는 방법을 언급하며 팁을 제공 할 것 입니다  
